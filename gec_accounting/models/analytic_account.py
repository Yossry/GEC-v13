...
class AnalyticAccount (models.Model):
    ...
    operation_type = fields.Selection([('terceros', 'Terceros'), ('obli_financiera', 'Obligación Financiera')], default='terceros',string='Tipo de operación')
    
    credit_type = fields.Selection([('ordinario', 'Ordinario'), ('ordinario_lp', 'Ordinario Largo Plazo'), ('credi_express', 'CrediExpress'), ('virtual', 'Virtual'), ('tesoreria', 'Tesoreria'), ('leasing', 'Leasing'), ('factoring', 'Factoring')], string='Tipo de crédito')
    ...
    def create(self, vals):
        ...
        if res.operation_type == 'obli_financiera':
            if res.term <= 0 or res.term > 130:
                raise UserError ('¡Los plazos de pago deben estar entre 1 y 130 meses!')
            if res.bank_quote <= 0:
                raise UserError ('El cupo bancario no puede ser inferior o igual a cero.')
